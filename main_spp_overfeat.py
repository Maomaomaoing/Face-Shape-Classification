...
import pandas as pd
from model_spp_overfeat import MODEL
...
os.environ['CUDA_VISIBLE_DEVICES']='4' #use which GPU device
	...
	for e in range(EPOCH):
		...
		if (e+1) % 5 ==0 or e == 0: 
			...
			if np.mean(train_acc) > 0.95:
				saver.save(sess, './spp_overfeat_model/'+ 'face_' + str(e+1) + '.ckpt')
			...
			out_df.to_csv("res_spp_overfeat.csv", index=False)
